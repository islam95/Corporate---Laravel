<div id="content-home" class="content group">
    ...
    @foreach($portfolio as $i => $item)
                ...
                <div class="work-thumbnail">
                    ...
                    <div class="work-overlay">
                        ...
                        <p class="work-overlay-categories">
                            ...
                            in: <a href="#">{{ $item->tag->title }}</a>
                        </p>
                    </div>
                </div>
                <div class="work-description">
                    <h2><a href="{{ route('portfolios.show', ['alias' => $item->alias]) }}">{{ $item->title }}</a></h2>
                    <p class="work-categories">in: <a href="#">{{ $item->tag->title }}</a></p>
                    <p>{!! str_limit($item->text, 243) !!}</p>
        ...
        @endif
                <div class="related_project{{ ($i == 4) ? ' related_project_last' : '' }}">
